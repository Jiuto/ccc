...
// 所有用餐类型及其选项
const mealTypes = [
  { name: '在公司吃', options: [...orgOptions, ...commonOptions] },
  { name: '在家吃 (单人版)', options: [...homeOptions1, ...commonOptions] },
  { name: '在家吃 (双人版)', options: homeOptions2 },
  { name: '出去吃', options: outingOptions }
];
...
Component({
  ...
  methods: {
    ...
    randomPick() {
      ...
      const options = mealTypes[typeIndex].options;
